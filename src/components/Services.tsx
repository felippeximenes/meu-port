...
function ServiceCard({ s, num, pos, delay }: { s: Service; num: string; pos: typeof GRID_POS[number]; delay: number }) {
  ...
  const cardContent = s.dark ? (
    ...
    <div style={{
      ...
      <h3 style={{ position: 'relative', margin: 0, fontFamily: "'Space Grotesk', sans-serif", fontSize: 'clamp(20px, 1.8vw, 28px)', fontWeight: 600, color: '#fff', lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: 16 }}>
        {s.title}
      </h3>
    ...
    <div style={{
      ...
      <h3 style={{ margin: 0, fontFamily: "'Space Grotesk', sans-serif", fontSize: 'clamp(20px, 1.8vw, 26px)', fontWeight: 600, color: 'var(--fg)', lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: 16 }}>
        {s.title}
      </h3>
    ...
    <section id="servicos" style={{ background: '#F8F7F5', padding: '80px 0 120px' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 48px' }}>
        ...
        <div ref={ref} style={{ ...style, display: 'grid', gridTemplateColumns: '200px 1fr', gap: 48, marginBottom: 56, alignItems: 'start' }}>
          ...
          <h2 style={{ margin: 0, fontFamily: "'Space Grotesk', sans-serif", fontWeight: 400, fontSize: 'clamp(28px, 3.4vw, 48px)', lineHeight: 1.12, letterSpacing: '-0.02em' }}>
