  ...
  return (
    <div ref={ref} style={{ ...style, marginLeft: right ? 'auto' : 0, width: 'min(560px, 90%)' }}>
      <div style={{ background: 'var(--dark-card)', border: '1px solid var(--dark-line)', borderRadius: 18, padding: '26px 28px' }}>
        <span style={{ display: 'inline-flex', width: 34, height: 34, borderRadius: '50%', background: 'rgba(255,255,255,0.06)', alignItems: 'center', justifyContent: 'center', fontFamily: "'Manrope', sans-serif", fontSize: 14, color: '#a8a6ad', marginBottom: 16 }}>{st.n}</span>
  ...
  return (
    <section id="processo" className="noise-bg" style={{ borderRadius: '32px 32px 0 0', padding: '110px 48px' }}>
      <div ref={head.ref} style={{ ...head.style, maxWidth: 720, margin: '0 auto 56px' }}>
        ...
        <h2 style={{ margin: '18px 0 0', fontFamily: "'Manrope', sans-serif", fontWeight: 400, fontSize: 'clamp(32px, 3.4vw, 50px)', lineHeight: 1.15, color: '#fff' }}>
          Um processo simples e claro, <em style={{ color: '#8b8890', fontFamily: "'Playfair Display', serif", fontStyle: 'italic', fontWeight: 400 }}>da primeira conversa à entrega final.</em>
        </h2>
      </div>
